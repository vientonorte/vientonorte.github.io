...
Thanks.`};function f(t,n){r(`generate_lead`,{category:`conversion`,lead_type:`free_a11y`,package_id:`radar`,freemium:!0,channel:n,origin:t}),r(`free_radar_entry_open`,{origin:t,package_id:`radar`,freemium:!0,channel:n}),e.clickHeroFreeAudit()}function p(e,t,r=`free-radar`,i={}){let o=i.mode??`auto`,s=()=>{f(r,`contact_form`),u(e,{origin:r,source:`cta`,intent:`consulting`,packageId:`radar`,message:d[t],consultingQ1:`radar-free`})};return o===`message`?(s(),`contact_form`):o===`schedule`||o===`auto`?(f(r,`google_calendar`),a({origin:r,intent:`radar-free`,notes:`Agenda 30 min · revisión de un flujo (vientonorte.io)`}),window.setTimeout(()=>{n(s)},300),`google_calendar`):(s(),`contact_form`)}function m(){return!!t}export{c as a,u as i,p as n,l as r,m as t};